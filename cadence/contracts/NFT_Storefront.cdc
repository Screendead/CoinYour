...
//Name: NFTStorefront	TestNet: 0x94b06cfca1d8a476	MainNet: 0x4eb8a10cb9f87357
...
pub contract NFTStorefront {
    ...
    pub resource Listing: ListingPublic {
        ...
        pub fun purchase(payment: @FungibleToken.Vault): @NonFungibleToken.NFT {
            ...
            // At this point, if all receivers were active and availabile, then the payment Vault will have
